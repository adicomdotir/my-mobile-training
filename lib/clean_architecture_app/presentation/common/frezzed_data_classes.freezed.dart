...
class _$_RegisterObject implements _RegisterObject {
  _$_RegisterObject(this.countryMobileCode, this.username, this.password,
  ...
  @override
  String toString() {
    return 'RegisterObject(countryMobileCode: $countryMobileCode, username: $username, password: $password, email: $email, mobileNumber: $mobileNumber, profilePicture: $profilePicture)';
  }
